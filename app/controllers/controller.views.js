...
export const postLogin = async (req, res) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return res.render("login", { error: data.error || data.message || "Credenciales inválidas" });
        }
...
export const postCrearUsuario = async (req, res) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return res.render("crear", { error: data.error || data.message || "Error al crear usuario" });
...
export const postEditarUsuario = async (req, res) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return res.render("editar", { usuario, error: data.error || data.message || "Error al actualizar" });
